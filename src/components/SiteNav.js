...
const SiteNav = props => {
  return (
    <StyledSiteNav className="apps">
      ...
      <Link className="site-nav-link" to="/cases" activeStyle={activeStyles}>
        Cases
      </Link>
      <Link className="site-nav-link" to="/news" activeStyle={activeStyles}>
        News
      </Link>
      <Link className="site-nav-link" to="/events" activeStyle={activeStyles}>
        Events
      </Link>
      <Link className="site-nav-link" to="/about" activeStyle={activeStyles}>
        About
      </Link>
      <Link className="site-nav-link" to="/contact" activeStyle={activeStyles}>
        Contact
      </Link>
    </StyledSiteNav>
  )
