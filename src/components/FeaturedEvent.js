  ...
  <StaticQuery
    ...
    render={data => {
      ...
      const upcomingEvents = allEvents.filter(
        event => Date.now() - Date.parse(event.node.frontmatter.time) <= 0
      )
      ...
      const hasOwnUpgomingEvents =
        hasUpcomingEvents && ownUpcomingEvents.length > 0 ? true : false
              ...
              <div className="content-wrapper">
                ...
                {!hasOwnUpgomingEvents && (
                  <Link to="/events">
                    ...
                    <p>
                      {friendsUpcomingEvents[0].node.frontmatter.shorttitle}
                    </p>
                    <span className="read-more">Read more</span>
                  </Link>
                )}
