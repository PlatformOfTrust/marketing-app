    ...
    <ToolsSection className="container" bgColor={props.bgColor}>
      ...
      <div className="row mb-5 mb-md-3 mb-lg-0">
        ...
        <div className="col-md-4 col-lg-4">
          <h3>Hack data</h3>
          <p>
            Our developer portal has all the tools and data you need in order to
            create new solutions and services. This portal has been built from
            the point of view of a developer in order to create the best
            possible DX.
          </p>
        </div>
      ...
      <div className="row mb-5 mb-md-3 mb-lg-0">
        ...
        <div className="col-md-4 col-lg-4">
          <h3>Rule data</h3>
          <p>
            My world is a visualisation tool where you can manage your data in a
            digital twin, see where it comes from and where it links to.
          </p>
        </div>
      ...
      <div className="row mb-5 mb-md-3 mb-lg-0">
        ...
        <div className="col-md-4 col-lg-4">
          <h3>Sell &amp; Buy</h3>
          <p>
            Make your data earn. We are creating a marketplace for data products
            and applications where you can offer your data for others to utilise
            or a ready-made service or application for others to buy. You define
            the pricing, we take care of contracts and licensing. Automatically.
          </p>
        </div>
        <div className="disabled button-col col-md-3 col-lg-2">
          <Link to="/">
