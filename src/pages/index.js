    ...
    <Layout>
      ...
      <StyledMain className="home page-content container">
        ...
        <div className="row mt-5">
          ...
          <div className="col-6 offset-md-1 col-lg-3 offset-lg-0">
            <StyledBenefits>
              {contents
                .filter(
                  content => content.node.frontmatter.section === 'benefits'
                )
                .map(({ node }) => {
                  // console.log('[index.js] ContentMapping:', node )
                  return (
        ...
        <div className="row mt-3">
          {contents
            .filter(
              content => content.node.frontmatter.section === 'definition'
            )
            .map(({ node }) => {
              return (
                <div
        ...
        <div className="row mt-3 mb-5">
          <div className="col-12 col-md-10 offset-md-1 ">
            <div id="hex-blurbs" className="row">
              {contents
                .filter(
                  content => content.node.frontmatter.section === 'hex-blurbs'
                )
                .map(({ node }) => {
                  return (
                    <div
        ...
        <div className="row mt-5">
          ...
          <StyledPartners id="partners" className="col-10 offset-1">
            {contents
              .filter(
                content => content.node.frontmatter.section === 'partners'
              )
              .map(({ node }) => {
                return (
                  <div
