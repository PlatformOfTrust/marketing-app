              ...
              <div className="row">
                <div className="potevents col-md-6">
                  ...
                  {ownEventsNow.length === 0 && (
                    <StyledDefault>
                      <h2>
                        No upcoming events for now. Sign up for news to receive
                        events info and follow us
                      </h2>
                      <Link to="/newsletter">
                            ...
                            {post.frontmatter.potevent && (
                              ...
                              >
                                <StyledHexImage>
                                  ...
                                  <HexImage
                                    pic={require(`.${post.frontmatter.path}/${
                            ...
                            <div className="meta">
                              <p>
                                <FontAwesomeIcon
                                  icon={['fa', 'hexagon']}
                                  color={
                                    subtypeColors[post.frontmatter.subtype]
                                  }
                                />
